<?php //[STAMP] eb50c53a8d545f5aa907cc6c172d416a
...
trait AcceptanceTesterActions
{
     ...
     * ?>
     * ```
     * Or provide an associative array for the second argument to specifically define which selection method should be
     * used:
     * ``` php
     * <?php
    ...
    {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('dontSeeResponseCodeIs',
                                                                                        func_get_args()));
    }
